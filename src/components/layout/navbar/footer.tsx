...
//   return (
//     <footer className="relative overflow-hidden mt-16  border border-[#dfeceb] bg-gradient-to-r from-[#eef6ff] via-[#f5fbff] to-[#e7faf7] shadow-[0_10px_30px_rgba(15,118,110,0.05)]">
//       {/* BACKGROUND EFFECTS */}
...
//                   <button
//                     key={index}
//                     className="w-11 h-11 rounded-full bg-white border border-[#E3EEEB] flex items-center justify-center text-[#18B7A0] shadow-sm transition-all duration-300 hover:bg-[#18B7A0] hover:text-white hover:-translate-y-1"
//                   >
//                     <Icon size={18} />
//                   </button>
//                 ),
...
//             {/* LEFT IMAGE */}
//             <div className="relative w-[170px] h-[170px] mt-6">
//               <Image
...
//               <h3 className="text-xl font-semibold text-[#0B1533]">Shop</h3>
//             </div>
...
//                 <li
//                   key={item}
//                   className="flex items-center gap-2 text-[#4A5565] hover:text-[#18B7A0] transition-all duration-300 cursor-pointer"
//                 >
...
//               <h3 className="text-xl font-semibold text-[#0B1533]">
//                 Help & Support
//               </h3>
//             </div>
...
//               <h3 className="text-xl font-semibold text-[#0B1533]">About Us</h3>
//             </div>
...
//                 className="w-full h-13 rounded-full border border-white bg-white px-5 pr-14 outline-none shadow-sm focus:border-[#18B7A0]"
//               />

//               <button className="absolute right-2 top-1.5 w-10 h-10 rounded-full bg-gradient-to-r from-[#1CC7B2] to-[#18B7A0] flex items-center justify-center text-white">
//                 <Send size={18} />
//               </button>
//             </div>

//             {/* RIGHT IMAGE */}
//             <div className="relative w-full h-[220px] flex justify-end pr-6 -mt-2">
//               <Image
//                 src="/images/medical.png"
//                 alt="medical"
//                 fill
//                 className="object-contain scale-125 object-right"
//               />
//             </div>
...
//           <div className="w-full max-w-[1200px] rounded-[30px] bg-white/90 backdrop-blur-md border border-[#E3EEEB] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 overflow-hidden shadow-[0_10px_30px_rgba(15,118,110,0.06)]">
//             {[
//               {
//                 icon: ShieldCheck,
...
//             <div className="w-[160px] h-[52px] relative">
//               <Image
...
import { useLanguage } from "../../../context/LanguageContext"; // تأكد من مسار الاستيراد الصحيح
    ...
    <footer className="relative overflow-hidden mt-16  border border-white/40 bg-gradient-to-r from-[#eef6ff] via-[#f5fbff] to-[#e7faf7] shadow-[0_20px_50px_rgba(15,118,110,0.08)] backdrop-blur-xl">
      ...
      <div className="relative z-10 px-8 md:px-14 pt-10 pb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="text-xl font-semibold text-[#115e59]">{t.shop}</h3>
            </div>
            ...
            <ul className="space-y-4">
              {[
                ...
                { label: t.medicines },
                { label: t.supplements },
                { label: t.personalCare },
                { label: t.beautyProducts },
                { label: t.oralCare },
              ].map((item, index) => (
                <li
                  key={index}
          ...
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="text-xl font-semibold text-[#115e59]">{t.aboutUs}</h3>
            </div>

            <ul className="space-y-4">
              {[
                { label: t.aboutPharmaCare },
                { label: t.ourMission },
                { label: t.careers },
                { label: t.blog },
          ...
          <div>
            ...
            <motion.div
              ...
              className="relative w-full h-[220px] flex justify-end pr-6 -mt-3"
            >
              <Image
                src="/images/medical.png"
                alt="medical"
        ...
        <div className="relative flex items-center justify-center -mt-4 z-20">
          <div className="w-full max-w-[1200px] rounded-[32px] bg-white/80 backdrop-blur-xl border border-white/60 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 overflow-hidden shadow-[0_15px_40px_rgba(15,118,110,0.08)]">
            {[
              { icon: ShieldCheck, title: t.genuineProducts },
              { icon: Truck, title: t.fastDelivery },
              { icon: Headphones, title: t.expertSupport },
              { icon: CreditCard, title: t.securePayments },
            ].map((item, index) => {
              const Icon = item.icon;
              return (
                <motion.div
      ...
      <div className="border-t border-[#DDEDEA] bg-white/30 backdrop-blur-md px-8 md:px-14 py-5">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          {/* PAYMENTS */}
          <div className="flex items-center gap-3 flex-wrap justify-center">
            {["/images/visa.png", "/images/mastercard.png", "/images/applepay.png", "/images/paypal.png"].map((item, index) => (
              <motion.div
                whileHover={{ y: -3 }}
                key={index}
                className="w-[90px] h-[55px] bg-white border border-[#DDEDEA] rounded-2xl shadow-sm flex items-center justify-center"
              >
                <Image src={item} alt="payment" width={55} height={28} className="object-contain" />
              </motion.div>
            ))}
          </div>
          ...
          {/* STORE BUTTONS */}
          <div className="flex gap-3 flex-wrap justify-center">
            <motion.div whileHover={{ scale: 1.04 }} className="w-[160px] h-[52px] relative">
              <Image src="/images/googleplay.png" alt="google play" fill className="object-contain" />
            </motion.div>
            <motion.div whileHover={{ scale: 1.04 }} className="w-[160px] h-[52px] relative">
